...
const Home = () => {
  return (
    <div
      className={`pt-6 lg:pt-10 bg-[url("/assets/home/background-home-mobile.jpg")] md:bg-[url("/assets/home/background-home-tablet.jpg")] lg:bg-[url("/assets/home/background-home-desktop.jpg")]  bg-no-repeat bg-cover h-[41.6875rem] md:h-[64rem] lg:h-[56.25rem] `}
    >
      <Navbar />
