...
const Home = () => {
  return (
    <div
      className={`pt-6 lg:pt-10 min-h-screen bg-[url("../src/assets/home/background-home-mobile.jpg")] md:bg-[url("../src/assets/home/background-home-tablet.jpg")] lg:bg-[url("../src/assets/home/background-home-desktop.jpg")]  bg-no-repeat bg-cover overflow-x-hidden h-[41.6875rem] md:h-[64rem] lg:h-[56.25rem] `}
    >
      <Navbar />
